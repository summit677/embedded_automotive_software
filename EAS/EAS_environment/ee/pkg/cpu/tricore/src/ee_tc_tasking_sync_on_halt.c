...
#if defined(_REGTC27X_H) || defined(_REGTC27XB_H) || defined(_REGTC2D5T_H) || defined(_REGTC26X_H) || defined(_REGTC29X_H) || defined(_REGTC29XB_H)
...
#elif	   defined(_REGTC26X_H) || defined(_REGTC29X_H) || defined(_REGTC29XB_H)
#  if !defined(__CORE_TC16X__)
#    error Internal inconsistency.
#  endif
...
#  define _ICACHE_BIT1	PMI_CON1.B.PBINV
	...
	|| defined(_REGTC26X_H)  || defined(_REGTC29X_H) || defined(_REGTC29XB_H)
