...
MEMORY
{
  ...
  PMU_PFLASH_ABS18: org = 0x80002000, len = 4k
  /* - Program Flash Memory (PFLASH1) */
  PMU_PFLASH:  org = 0x80200000, len = 1M
  /* - Data Flash Memory (DFLASH0) */
  PMU_DFLASH0:  org = 0xAF080000, len = 256k
  /* - Data Flash Memory (DFLASH1) */
  PMU_DFLASH1:  org = 0xAF118000, len = 16K

  /* - Boot ROM (BROM) */
  BROM:  org = 0x8FFF8000, len = 32K

  /* - Scratch-Pad RAM (PSPR) (0x2500 + 0x3B00 = 24k) */
  PMI_PSPR_STARTUP:  org = 0x60100000, len = 0x2500
  PMI_PSPR:  org = 0x60102500, len = 0x3B00
  /* - Local Data Scratch-Pad RAM (DSPR) */
  DMI_DSPR: org = 0x60000000, len = 112K
  /* - Data RAM */
  LMU_SRAM:  org = 0x90004000, len = 8K
}
