...
## Edited: Fabian Mauroner 2015
## 
##
ifeq ($(and $(call iseeopt, EE_TRICORE__), $(call iseeopt, EE_TC29X__)),yes)
ifeq ($(or $(call iseeopt, EE_TASKING_4_0), $(call iseeopt, EE_DIAB__)),yes)
ifneq ($(call iseeopt,EE_USE_CUSTOM_STARTUP_CODE), yes)
EE_BOOT_SRCS += pkg/mcu/infineon_tc29x/src/ee_tc29x_cstart.c
endif # !EE_USE_CUSTOM_STARTUP_CODE
EE_SRCS += pkg/mcu/infineon_tc29x/src/ee_tc29x_system.c
EE_SRCS += pkg/mcu/infineon_tc29x/src/ee_tc29x_internal.c
endif # TASKING || DIAB
endif # TRICORE TC29X
