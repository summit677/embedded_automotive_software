 ...
 * ###*E*### */
 ...
 /** @file   ee_tc29x_internal.h
  *  @brief  MCU-dependent internal part of HAL
  *  @author Errico Guidieri
  *  @date 2012
  */
#ifndef INCLUDE_EE_TC29X_INTERNAL_H__
#define INCLUDE_EE_TC29X_INTERNAL_H__


/* Internals must view MCU API */
#include "mcu/infineon_tc29x/inc/ee_tc29x_mcu.h"
...
__INLINE__ void __ALWAYS_INLINE__ EE_tc29x_configure_clock_ctrl ( void )
{
  /* Configure CCUCON0 */
  SCU_CCUCON0.U = EE_TC29X_CCUCON0_BAUD1DIV(1U) |
    EE_TC29X_CCUCON0_SRI(1U) | EE_TC29X_CCUCON0_SPB(2U) |
    EE_TC29X_CCUCON0_FSI2(2U) | EE_TC29X_CCUCON0_FSI(2U) |
    EE_TC29X_CCUCON0_CLKSEL(1U);

  /* Configure CCUCON1 and Update all CCU */
  SCU_CCUCON1.U =  EE_TC29X_CCUCON1_STMDIV(1U) |
    EE_TC29X_CCUCON1_GTMDIV(1U) | EE_TC29X_CCUCON1_INSEL(1U) |
    EE_TC29X_CCUCONX_UP;
}

__INLINE__ void __ALWAYS_INLINE__ EE_tc29x_configure_osc_ctrl ( void )
{
  /*
   * Default System Oscillator Configuration
   * MODE:    0   -> External Crystal
   */
  SCU_OSCCON.U= EE_TC29X_SCU_OSCCON_OSCRES | EE_TC29X_SCU_OSCCON_GAINSEL |
      EE_TC29X_SCU_OSCCON_MODE(0U) | EE_TC29X_SCU_OSCCON_OSCVAL(7U);
...
/*  I will use n=60 and p=2. Because I can get al the
    needed values */
#define EE_TC29X_PLL_NDIV           60U
#define EE_TC29X_PLL_PDIV           2U

/* This function accept fpll in HZ */
 __INLINE__ void __ALWAYS_INLINE__ EE_tc29x_configure_clock_internal(
    EE_UREG fpll)
{
  /* k2 divider value */
  EE_UINT32 k2;
  /* Adjust fcpu if needed */
  if(fpll > EE_TC29X_CLOCK_MAX) {
      fpll = EE_TC29X_CLOCK_MAX;
  } else if (fpll < EE_TC29X_CLOCK_MIN) {
      fpll = EE_TC29X_CLOCK_MIN;
  }
  else {
  ...
  k2 = (((EE_TC2YX_BOARD_FOSC / EE_MEGA) * EE_TC29X_PLL_NDIV) /
      ((fpll / EE_MEGA) * EE_TC29X_PLL_PDIV)) - 1U;
  ...
  /*  I will use n=60 and p=2. Because I can get al the
      needed values */
  SCU_PLLCON0.B.PDIV= EE_TC29X_PLL_PDIV - 1U;
  SCU_PLLCON0.B.NDIV= EE_TC29X_PLL_NDIV - 1U;
...
#else
#define EE_tc29x_configure_clock_ctrl() ((void)0)
#define EE_tc29x_configure_osc_ctrl()   ((void)0)
#define EE_tc29x_configure_clock()      ((void)0)
...
/**
  ...
  *   for monitoring
  */
__INLINE__ void __ALWAYS_INLINE__ EE_tc29x_fill_stacks( void )
{
  /* User Stack end */
...
#define EE_tc29x_fill_stacks() ((void)0U)
 ...
 */
__INLINE__ EE_UREG __ALWAYS_INLINE__ EE_tc29x_conf_common_memory_prot( void )
{
  /* Ram Begin Address */
...
#define EE_tc29x_conf_common_memory_prot() 0U;
#endif /* __EE_MEMORY_PROTECTION__ */

/*
 * Set the given bitmask on SYSCON register
 */
__INLINE__ void __ALWAYS_INLINE__ EE_tc29x_set_syscon( EE_UREG syscon_value )
{
 ...
 */
void EE_tc29x_enable_protections( void );
 ...
 */
__INLINE__ void __ALWAYS_INLINE__ EE_tc29x_enable_protections( void )
{
  /* Configure Memory Protection common part and obtain the starting mask for
     syscon register */
  register EE_UREG syscon_value = EE_tc29x_conf_common_memory_prot();
  ...
  /* Set the given bitmask on SYSCON register */
  EE_tc29x_set_syscon(syscon_value);
}
...
#define EE_tc29x_enable_protections() ((void)0U)
...
void EE_tc29x_initialize_system_timer(void);
#else /* ENABLE_SYSTEM_TIMER && EE_SYSTEM_TIMER_DEVICE */
#define EE_tc29x_initialize_system_timer() ((void) 0)
...
/* If a CPU CLOCK frequency is defined configure the SCU registers */
  ...
  EE_tc29x_configure_clock_ctrl();
  /********* Configure Oscillator Control. *********/
  EE_tc29x_configure_osc_ctrl();
  /***************** Configure PLL *****************/
  EE_tc29x_configure_clock( EE_CPU_CLOCK );
