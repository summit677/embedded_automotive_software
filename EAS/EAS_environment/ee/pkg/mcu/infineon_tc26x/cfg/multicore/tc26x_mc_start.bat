...
start %P4_SYS%\bin\%P11_ARCH%\t32mtc -c config_tc27x_mc.t32 %P1_PORT% %P2_TITLE% %P3_TMP% %P4_SYS% %P5_HELP% %P6_PBI% %P7_OPT% %P8_OPT% %P9_OPT% -s %P10_SCRIPT%
