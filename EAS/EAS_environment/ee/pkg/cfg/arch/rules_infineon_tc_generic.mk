...
## Modified: 2015 Fabian Mauroner (added HEX generation, AppKit 2X7 support)
##
...
TRICORE_STEP = c
else ifeq ($(and $(call iseeopt, EE_APPKIT_TC2X7), $(call iseeopt, EE_TC29X__)),yes)
TRICORE_STEP = b
else
TRICORE_STEP =
endif
...
all: rm_elfs make_directories $(ALL_LIBS) $(TARGET) $(EE_SCRIPTS)
else
all: rm_elfs make_directories $(ALL_LIBS) $(TARGET) $(TARGET_NAME).hex $(EE_SCRIPTS)
endif
...
else ifeq ($(call iseeopt, EE_APPKIT_TC2X7),yes)
	@echo $(call native_path, $(T32SYS))/bin/$(T32ARCH)/t32mtc -s t32.cmm CPU=TC297T >> $@	
else
...
$(TARGET_NAME).hex: $(TARGET_NAME).elf	
	@echo "GEN $@";
	$(QUIET)$(EE_OBJCOPY) -O ihex $< $@
	@echo "**************************"
	@echo "Hex created successfully!"
