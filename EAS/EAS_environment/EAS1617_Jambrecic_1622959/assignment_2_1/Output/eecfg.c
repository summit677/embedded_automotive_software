 ...
 **************************************************************************/
    ...
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_2[EE_STACK_WLEN(STACK_2_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_2);	/* Task 1 (Task2) */
    ...
    struct EE_TC_TOS EE_tc_system_tos[EE_TC_SYSTEM_TOS_SIZE] = {
        ...
        {EE_STACK_INITP(EE_tc_stack_2), 0U} 	/* Task 1 (Task2) */
    };
 ...
 **************************************************************************/
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        {system_counter, alarm_task1, EE_ALARM },
        {system_counter, alarm_task2, EE_ALARM }
    };
