 ...
 **************************************************************************/
    ...
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_1[EE_STACK_WLEN(STACK_1_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_1);	/* Task 0 (Task_Alarm1) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_2[EE_STACK_WLEN(STACK_2_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_2);	/* Task 1 (Task_Alarm2) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_3[EE_STACK_WLEN(STACK_3_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_3);	/* irq stack */
    ...
    struct EE_TC_TOS EE_tc_system_tos[EE_TC_SYSTEM_TOS_SIZE] = {
        {0, 0U},	/* Task   (dummy) */
        {EE_STACK_INITP(EE_tc_stack_1), 0U},	/* Task 0 (Task_Alarm1) */
        {EE_STACK_INITP(EE_tc_stack_2), 0U} 	/* Task 1 (Task_Alarm2) */
    };
 ...
 **************************************************************************/
    ...
    DeclareTask(Task_Alarm1);
    DeclareTask(Task_Alarm2);

    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &EE_oo_thread_stub,		 /* thread Task_Alarm1 */
        &EE_oo_thread_stub 		 /* thread Task_Alarm2 */
    ...
    const EE_TYPEPRIO EE_th_ready_prio[EE_MAX_TASK] = {
        0x1U,		 /* thread Task_Alarm1 */
        0x2U 		 /* thread Task_Alarm2 */
    };
 ...
 **************************************************************************/
    ...
    */
    ...
    const EE_TYPEPRIO EE_resource_ceiling[EE_MAX_RESOURCE]= {
        0x2U,		/* resource resource1 */
        0x2U 		/* resource resource2 */
    };
 ...
 **************************************************************************/
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        {system_counter, Alarm1, EE_ALARM },
        {system_counter, Alarm2, EE_ALARM }
    };
 ...
 **************************************************************************/
    const EE_oo_action_ROM_type   EE_oo_action_ROM[EE_ACTION_ROM_SIZE] = {
        ...
        {EE_ACTION_TASK    , Task_Alarm1, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , Task_Alarm2, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 }
    };
