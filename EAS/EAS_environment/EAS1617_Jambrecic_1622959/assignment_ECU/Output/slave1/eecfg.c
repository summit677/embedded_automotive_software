 ...
 **************************************************************************/
    ...
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_1[EE_STACK_WLEN(STACK_1_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_1);	/* Task 0 (TaskPwm) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_2[EE_STACK_WLEN(STACK_2_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_2);	/* Task 1 (TaskPin) */
    ...
    struct EE_TC_TOS EE_tc_system_tos[EE_TC_SYSTEM_TOS_SIZE] = {
        {0, 0U},	/* Task   (dummy) */
        {EE_STACK_INITP(EE_tc_stack_1), 0U},	/* Task 0 (TaskPwm) */
        {EE_STACK_INITP(EE_tc_stack_2), 0U} 	/* Task 1 (TaskPin) */
    };
 ...
 **************************************************************************/
    ...
    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &EE_oo_thread_stub,		 /* thread TaskPwm */
        &EE_oo_thread_stub 		 /* thread TaskPin */
